...
void CopyArray(int arr1[100], int copyArr[100], int length1, int& length2) {
...
int main() {
	...
	CopyArray(arr1, copyArr, arr1Length, arr2Length);
	cout << "\nArray 2 Elements after copy using add method: \n";
